...
ENCOURAGEMENTS = [
    ...
    "오늘 흘린 땀방울이 135회 기계안전기술사 합격으로 돌아올 거예요. 아자쓰! 🔥",
...
# [화면 구성] 메인 학습 화면
# ==========================================
st.markdown("<div class='neon-title'>POSCO FUTURE M<br>기계안전기술사 AI 센터</div>", unsafe_allow_html=True)
...
<div style="text-align: center; color: #64748b; font-size: 12px;">
    © POSCO FUTURE M Assistant. 지연님의 기계안전기술사 합격을 진심으로 기원합니다!
</div>
""", unsafe_allow_html=True)
